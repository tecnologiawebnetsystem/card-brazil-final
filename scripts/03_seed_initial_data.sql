...
VALUES ('CardBrazil Administradora Ltda', 'CardBrazil', '12.345.678/0001-90', 'contato@cardbrazil.com.br', 'ativo')
...
SELECT 
  1,
  'Admin Demo',
  'admin@cardbrazil.com.br',
  '$2a$10$rZ3qKx5qQJ5mXvZhGZ5N4e6K5YvYxZqKx5qQJ5mXvZhGZ5N4e6K5Y',
  true,
  true
WHERE NOT EXISTS (SELECT 1 FROM usuarios WHERE email = 'admin@cardbrazil.com.br' AND id_administradora = 1);
...
FROM usuarios u
CROSS JOIN roles r
WHERE u.email = 'admin@cardbrazil.com.br' 
