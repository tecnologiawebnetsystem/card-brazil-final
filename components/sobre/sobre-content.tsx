        ...
        <div className="container mx-auto px-6 relative">
          <div className="bg-[#141414] border border-[#262626] rounded-2xl p-8 lg:p-12">
            ...
            <div className="space-y-6 text-[#a3a3a3] leading-relaxed text-base lg:text-lg">
              <p>
                O <span className="text-[#008080] font-bold">CardBrazil</span> nasceu da experiencia da{" "}
              ...
              <p>
                ...
                <span className="text-[#008080] font-bold">CardBrazil</span> para ser a solucao completa
