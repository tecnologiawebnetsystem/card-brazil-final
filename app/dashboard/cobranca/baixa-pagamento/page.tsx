...
import { Search, MoreHorizontal, CheckCircle, X, User, Users, Building, FileText, Printer, Mail } from "lucide-react"
...
export default function BaixaPagamentoPage() {
  const [searchType, setSearchType] = useState<"beneficiario" | "outros">("beneficiario")
          ...
          <CardContent className="p-6 space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <div className="space-y-2">
                ...
                <Input
                  id="adicFrac"
                  value={formData.adicFrac}
                  onChange={(e) => setFormData({ ...formData, adicFrac: e.target.value })}
                  readOnly
                  className="bg-emerald-50 border-emerald-200"
                />
              </div>
              ...
              <div className="space-y-2">
                <Label htmlFor="valorPago" className="text-sm font-medium text-foreground">
              ...
              <div className="space-y-2">
                <Label htmlFor="dataPagamento" className="text-sm font-medium text-foreground">
