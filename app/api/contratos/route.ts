...
export async function POST(request: NextRequest) {
  try {
    ...
    const rows = await query(`INSERT INTO contratos (administradora_id, operadora_id, estipulante_id, numero_contrato, data_inicio, data_fim, quantidade_vidas, status) VALUES ($1,$2,$3,$4,$5,$6,$7,$8) RETURNING *`, [administradoraId, body.operadora_id, body.estipulante_id || null, body.numero_contrato, body.data_inicio, body.data_fim || null, body.quantidade_vidas || 0, body.status || "ativo"])
